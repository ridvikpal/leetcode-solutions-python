...
class Solution:
    ...
    def maxProfit(self, prices: List[int]) -> int:
        ...
        # we will use @cache to automatically memoize the results
        @cache
        def search(index, state):
            ...
            if state == 'buy':
                ...
                # finally, we will return the maximum
                # we got of buying or skipping
                return max(choose_buy, choose_skip)
            # our second state case is selling
                ...
                # finally, we will return the maximum
                # we got of selling or skipping
                return max(choose_sell, choose_skip)
