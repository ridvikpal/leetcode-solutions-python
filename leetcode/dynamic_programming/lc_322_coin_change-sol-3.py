...
class Solution:
    ...
    def coinChange(self, coins: List[int], amount: int) -> int:
        ...
        def search(index, amount):
            ...
            # check if we already have a memoized value stored
            ...
            # we will add the value of the decision that gives
            # the minimum answer to our memoization dict
            memoization[(index, amount)] = min(choose_this_coin, skip_this_coin)

            # finally we can return our memoization value
            return memoization[(index, amount)]
