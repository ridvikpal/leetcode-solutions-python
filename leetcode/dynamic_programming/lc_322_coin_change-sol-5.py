...
class Solution:
    ...
    def coinChange(self, coins: List[int], amount: int) -> int:
        ...
        def search(total):
            ...
            # if we don't have a memoized value for this total amount
            # then calculate it
            if total not in memoization:
                ...
                # finally, determine the minimum number of coins needed + 1
                # because we use 1 coin to create the total at this iteration
                # and store it in our memoization dict
                memoization[total] = min_coins + 1

            # return the memoized value for this total amount
